...
class Simulation:
    ...
    def add_simulations(self,rocket):
        self.rocket = rocket
    ...
    def run(self):
        l.subprocess.call(["java", "-jar", "D:/Documentos/lib/UnB/4Semestre/Capital/OpenRocketTurbo2.jar", "--runSimulations", self.rocket.file_path])
